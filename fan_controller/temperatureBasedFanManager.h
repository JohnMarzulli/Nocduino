#ifndef TEMP_BASED_FAN_DRIVER_H
#define TEMP_BASED_FAN_DRIVER_H

class TemperatureBasedFanManager {
public:

  TemperatureBasedFanManager() {
    _rotations = 0;
  }
...
int TemperatureBasedFanManager::_rotations = 0;

#endif  // TEMP_BASED_FAN_DRIVER_H